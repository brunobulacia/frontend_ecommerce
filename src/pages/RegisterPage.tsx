...
import { EyeIcon, EyeOffIcon, LockIcon, MailIcon, Package, UserIcon } from 'lucide-react'
      ...
      <div className="w-full max-w-md">
        <Card className="border-slate-700 bg-slate-800 shadow-xl">
          <CardHeader className="space-y-1">
            ...
            <CardTitle className="text-3xl font-bold text-center text-white">Crear cuenta</CardTitle>
          ...
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                {errors.nombre && (
                  <p className="text-sm text-red-400 mt-1">{errors.nombre.message}</p>
                )}
              </div>

              {/* Campo Apellidos */}
              <div className="space-y-2">
                <Label htmlFor="apellidos" className="text-sm font-medium text-slate-200">
                  Apellidos
                </Label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-slate-500">
                ...
                {errors.apellidos && (
                  <p className="text-sm text-red-400 mt-1">{errors.apellidos.message}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                {errors.correo && (
                  <p className="text-sm text-red-400 mt-1">{errors.correo.message}</p>
                )}
              </div>
              ...
              <div className="text-center text-sm text-slate-300">
                ...
                <Link to='/login' className="text-white hover:text-slate-200 font-medium">
